...
@section('css')
  ...
  <!-- bootstrap slider -->
  <link rel="stylesheet" href="{{url('assets/')}}/plugins/bootstrap-slider/css/bootstrap-slider.min.css">
@endsection
@section('js')
<!-- jQuery -->
...
<!-- Bootstrap slider -->
<script src="{{url('assets/')}}/plugins/bootstrap-slider/bootstrap-slider.min.js"></script>
<script>
  $(function () {
    /* BOOTSTRAP SLIDER */
